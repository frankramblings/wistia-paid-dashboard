...
function GridIcon() {
  return <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>;
}
function YouTubeIcon() {
  return <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M23.5 6.2a3.03 3.03 0 0 0-2.13-2.14C19.51 3.6 12 3.6 12 3.6s-7.51 0-9.37.48A3.03 3.03 0 0 0 .5 6.2C0 8.07 0 12 0 12s0 3.93.5 5.8a3.03 3.03 0 0 0 2.13 2.14C4.49 20.4 12 20.4 12 20.4s7.51 0 9.37-.46A3.03 3.03 0 0 0 23.5 17.8C24 15.93 24 12 24 12s0-3.93-.5-5.8zM9.6 15.6V8.4L15.87 12 9.6 15.6z"/></svg>;
}
...
const TABS = [
  ...
  { label: 'Meta',     href: '/paid/meta',     Icon: MetaIcon },
