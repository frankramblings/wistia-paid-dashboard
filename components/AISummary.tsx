...
export default function AISummary({
    ...
    return (
      <div className="mb-6 bg-[#f9f9fb] border border-w-border rounded-2xl overflow-hidden">
        <div className="px-5 py-3.5 border-b border-w-border">
          <div className="font-walsheim text-sm font-semibold text-w-hi">AI Summary</div>
        </div>
  ...
  return (
    <div className="mb-6 bg-[#f9f9fb] border border-w-border rounded-2xl overflow-hidden">
      ...
      {summary.actionItem && (
        <div className="mx-5 mb-5 px-4 py-3 bg-w-blue-bg rounded-md border-l-4 border-w-blue">
          <div className="text-xs font-semibold text-w-blue mb-1.5">Action Item</div>
